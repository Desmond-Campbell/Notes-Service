...
class NotesController extends \App\Http\Controllers\Controller
{
    ...
    public function store(Request $r): Object{
        $data = $r->data;
        $params = $r->params;
    ...
    public function get(Request $r): Object {
        $user_id = $r->user_id;
        $id = $r->_id;
        $note = Note::where('user_id', $user_id)->find($id);
        if ( !$note ) {
    ...
    public function browse(Request $r): Object {
        $user_id = $r->user_id;
    ...
    public function storeFolder(Request $r): Object {
        $data = $r->data;
        $params = $r->params;
    ...
    public function deleteFolder(Request $r): Object {
        $id = $r->_id;
        $user_id = $r->user_id;
        $folder = Folder::where('user_id', $user_id)->find($id);
        if ( $folder ) {
    ...
    public function getFolders(Request $r): Object {
        $user_id = $r->user_id;
    ...
    private function str_random( $length ): String {
